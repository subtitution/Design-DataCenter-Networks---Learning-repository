...
И каково же было мое удивление, после запуска icmp, когда я обнаружил, что трафик ICMP, приходит на leaf1, со стороны Spine1, но не Spine2, как ожидалось, снизу пример:
<br>
