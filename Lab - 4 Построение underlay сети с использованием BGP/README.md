...
Так же прошу обратить внимание, что нам доступны loopback адрес 10.0.0.2 через spine 1 (10.1.1.1) и Spine 2 (10.2.2.1) - эта информация отображается в Cluster-List в колонке Path. Но loopback leaf 3 доступен только через Spine 2. В этом нет ничего страшного, т.к. после предыдущей лабы, я забыл включить ethernet интерфейс на Leaf-3, идущий в сторону spine1. <br>
