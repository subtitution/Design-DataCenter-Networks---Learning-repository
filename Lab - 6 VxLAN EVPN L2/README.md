...
Как говорится, учиться надо на ошибках, так вот, все нижеследующее до пункта 3, неверно!. Я решил специально решил это оставить, чтобы было на чем учиться))). Так, что кому интересно, как правильно настроить, можно смело сразу переходить к <p><a href="first">foo</a></p> [Пункт 3 - Настройка].
