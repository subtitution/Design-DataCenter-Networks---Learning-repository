...
### Содержание
 1. Теория
 2. Практика и настройка анонса внешнего сервера (например DNS) во внутреннюю сеть фабрики
 3. Проверка работоспособности, поиск и устранение неисправности
 4. Настройка VRF leaking (анонс Ipv4 маршрута через route-type 5, сервера из одного VRF в другой VRF)
...
<br>
 ...
 Как видно успешно. <br>
 На этом первая часть лабораторной работы,  посвященная route type 5 маршрутам, а именно проброса (анонса) внешнего сервера в данном примере Сервера DNS 8.8.8.8 во внутреннюю сеть фабрики, закончена. В продолжении в четвертой части данной работы, вас ожидает не менее увлекательное чтиво, посвященное настройке vrf leaking внутри фабрики через внешний сервер, что это такое? Допустим У нас есть внешний роутер (фаервол, не важно), на который приходят маршруты и сети от фабрики между разными VRF, требуется с внешнего роутера  анонсировать Route type 5 маршрут из одного VRF в другой.
 ## 4.  Настройка VRF leaking (анонс Ipv4 маршрута через route-type 5, сервера из одного VRF в другой VRF)
 ## 5. Заключение - выводы
...
## 6. Конфигурация устройств
## 6.1. Конфигурация устройств первой части лабы до пукта 3 включительно.
<details>
...
iamgoogle>
 ...
 ```
  ...
  ## 6.2. Конфигурация устройств 2-й части лабы пункт 4.
